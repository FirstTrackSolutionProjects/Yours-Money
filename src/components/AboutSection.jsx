      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600 text-lg">
            YourMoney is a next-gen fintech platform designed to make digital payments,
            money transfers, and financial tracking effortless for individuals and businesses.
          </p>
          <Link
            to="/about"
