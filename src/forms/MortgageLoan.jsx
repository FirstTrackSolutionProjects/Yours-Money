  ...
  {formData.profession === "Service" && (
    <>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="text" name="MortgageProperty" value={formData.MortgageProperty} onChange={handleChange} placeholder="Mortgage Property" className="p-2 border rounded" required />
