      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
         ...
         <p className="text-gray-700 text-lg leading-relaxed">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            Built on advanced technology and strong compliance standards, <span className="text-black font-semibold">Yours</span>{" "}
          ...
          <div className="flex justify-center md:justify-start">
            <button className="mt-4 bg-gradient-to-r from-blue-600 to-teal-500 text-white px-8 py-3 rounded-full font-semibold hover:scale-105 transition-transform duration-300 shadow-lg">
              Learn More
            </button>
          </div>
        </div>
